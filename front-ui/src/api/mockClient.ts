...
const MOCK_TURNS: MockTurn[] = [
  { emotion: 'calm', transcript: '오늘 하루도 무사히 끝났어.', reply: '수고 많았어요. 오늘 하루는 어땠나요?', color: { hex: '#B8E0D2', brightness: 60, transition_ms: 1200 } },
  { emotion: 'joy', transcript: '오랜만에 친구를 만나서 기분이 좋았어.', reply: '좋은 시간을 보내셨네요! 그 얘기 더 들려주세요.', color: { hex: '#F4D58D', brightness: 75, transition_ms: 1200 } },
  { emotion: 'fatigue', transcript: '일이 너무 많아서 좀 지쳐.', reply: '많이 지치셨겠어요. 오늘은 푹 쉬는 게 좋겠어요.', color: { hex: '#E3B98A', brightness: 40, transition_ms: 1200 } },
  { emotion: 'anxiety', transcript: '내일 발표 때문에 좀 불안해.', reply: '긴장되시는 게 당연해요. 천천히 숨을 쉬어봐요.', color: { hex: '#9DB4C0', brightness: 45, transition_ms: 1200 } },
  { emotion: 'relief', transcript: '드디어 다 끝냈어, 마음이 편해.', reply: '정말 다행이에요. 편안한 마음으로 마무리해봐요.', color: { hex: '#C9E4CA', brightness: 65, transition_ms: 1200 } },
]
...
export async function mockEndSession(_sessionId: string): Promise<SessionEndResponse> {
  ...
  return {
    ...
    sleep_color: { hex: '#B8E0D2', brightness: 30, transition_ms: 2000 },
  }
}
